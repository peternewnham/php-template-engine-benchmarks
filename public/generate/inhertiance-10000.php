...
$parentTplName = 'inheritance-parent-10000';
$childTplName = 'inheritance-child-10000';
...
generateTemplate('smarty', $childTplName, function() {
	$tpl = array('{extends file="inheritance-parent-10000.tpl"}');
	for ($i=0; $i<10000; $i++) {
...
generateTemplate('twig', $childTplName, function() {
	$tpl = array('{% extends "inheritance-parent-10000.tpl" %}');
	for ($i=0; $i<10000; $i++) {
